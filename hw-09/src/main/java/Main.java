...
public class Main {
    public static void main(String[] args) throws IllegalAccessException, SQLException, NoSuchMethodException, InstantiationException, InvocationTargetException {
        ...
        template.create("create table Account(no bigint(20) NOT NULL auto_increment, type varchar(255),rest int(3))");
        ...
        System.out.println(template.load(1, User.class));
        System.out.println(template.load(3,Account.class));
    }
}
